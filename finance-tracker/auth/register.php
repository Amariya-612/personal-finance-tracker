 ...
 * Purpose: Registration page — same style as login page
 */
...
<head>
    ...
    <style>
        /* ── Page background: Pastel Grid (same as login) ── */
        ...
        @media (max-width: 640px) {
            ...
            .login-left { clip-path: none; padding: 2rem 1.5rem; }
